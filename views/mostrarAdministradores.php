...
<body>    
    ...
    <?php else: ?>
        <table id="example" class="display" style="width:100%">
            ...
            <tbody>
                <?php foreach ($administrador as $item): ?>
                    <tr>
                        ...
                        <td>
                            <!-- Botones de acciones -->
                            <button onclick="editarAdministrador(<?php echo $item['id']; ?>)">Editar</button>
                            <button id="btnEliminar" onclick="eliminarAdministrador(<?php echo $item['id']; ?>)">Eliminar</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <script src="../assets/scripts/accionesAdministrador.js"></script>
</body>
</html>
